    ...
    <nav style={styles.nav}>
      ...
      <div style={styles.logoContainer}>
        <img
          ...
          style={styles.logo}
        />
        <h1 style={styles.title}>Restaurant Hub.com</h1>
      </div>
...
function Navbar() {
  ...
  return (
    <nav style={styles.nav}>
      ...
      <ul style={styles.navLinks}>
        <li style={styles.navItem}><Link to="/" style={styles.link}>Home</Link></li>
        <li style={styles.navItem}><Link to="/about" style={styles.link}>About Us</Link></li>  {/* New About Us Link */}
        <li style={styles.navItem}><Link to="/reservation" style={styles.link}>Reserve Table</Link></li>
